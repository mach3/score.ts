...
- 9種類のビートパターン（キックのみ / キック+ハイハット）を Web Audio API でリアルタイム合成
- ADSRエンベロープによるゲイン制御
...
| パターン | キック | ハイハット | 説明 |
|---------|--------|-----------|------|
| `kick-2` | 1, 9拍目 | なし | 2ビート |
| `kick-4` | 1, 5, 9, 13拍目 | なし | 4ビート |
| `kick-8` | 奇数フレーム全て | なし | 8ビート |
| `triple` | 1, 7, 13拍目 | なし | 3連系 |
| `rock` | 1, 9拍目 | 8分音符 | 基本ロック |
| `pop` | 1, 5, 9, 13拍目 | 8分音符 | 4つ打ち+ハイハット |
| `offbeat` | 1, 9拍目 | 裏打ち（偶数フレーム） | オフビート |
| `shuffle` | 1, 9拍目 | シャッフル（3連系） | シャッフル |
| `16beat` | 1, 5, 9, 13拍目 | 16分音符全て | 16ビート |
